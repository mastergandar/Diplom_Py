...
!function (t, e) {
    ...
    }, zt = [].forEach, Dt = F(0), Vt = Nt("forEach") ? function (t) {
    ...
    var It = k.f, Bt = Function.prototype, Pt = Bt.toString, Ht = /^\s*function ([^ (]*)/;
    ...
    var Ft = Object.keys || function (t) {
        return bt(t, mt)
    }, qt = Object.assign, $t = !qt || e(function () {
        var t = {}, e = {}, i = Symbol();
    ...
    var Ee = "Expected a function", we = NaN, Oe = "[object Symbol]", _e = /^\s+|\s+$/g, Se = /^[-+]0x[0-9a-f]+$/i,
        Le = /^0b[01]+$/i, Ae = /^0o[0-7]+$/i, Me = parseInt,
        ke = "object" == typeof v && v && v.Object === Object && v,
        We = "object" == typeof self && self && self.Object === Object && self,
        Te = ke || We || Function("return this")(), Re = Object.prototype.toString, je = Math.max, Ce = Math.min,
        Ne = function () {
            return Te.Date.now()
        };
    ...
    var Ie = function (t, e, i) {
        ...
        }, Be = "Expected a function", Pe = NaN, He = "[object Symbol]", Fe = /^\s+|\s+$/g, qe = /^[-+]0x[0-9a-f]+$/i,
    ...
    var Ii = 20, Bi = ["top", "right", "bottom", "left", "width", "height", "size", "weight"],
    ...
    function Gi(t) {
        ...
        if (!e && !i) return $i;
        var r = qi(t).getComputedStyle(t), n = function (t) {
        ...
        function t(e, i) {
            ...
            this.onScroll = function () {
                ...
                var i = r.axis[r.draggedAxis].track, n = i.rect[r.axis[r.draggedAxis].sizeAttr],
                    s = r.axis[r.draggedAxis].scrollbar, o = r.contentWrapperEl[r.axis[r.draggedAxis].scrollSizeAttr],
