...
(function (d) {
    ...
    d.extend(i.prototype, {
        _constructor: function () {
            var a = this, b = this.s.dt, c = b.settings()[0], e = d(m).innerWidth();
            ...
            g = !1;
            e = 0;
            for (f = c.length; e < f; e++) if (!c[e].control && !c[e].never && !1 === j[e]) {
                g = !0;
                break
            }
            e = 0;
            for (f = c.length; e < f; e++) c[e].control && (j[e] = g), "not-visible" === j[e] && (j[e] = !1);
            ...
            if ("inline" === this.c.details.type) {
                var a = this.s.dt, b = d.inArray(!0, this.s.current);
            ...
            var b = this, c = this.s.dt, e = d(m).innerWidth(), f = this.c.breakpoints, g = f[0].name,
                j = this.s.columns, h, i = this.s.current.slice();
            ...
            f = !1;
            h = 0;
            for (e = j.length; h < e; h++) if (!1 === k[h] && !j[h].never && !j[h].control && !1 === !c.column(h).visible()) {
                f = !0;
                break
            }
            ...
            if (this.c.auto && -1 !== d.inArray(!0, d.map(b, function (a) {
                ...
                if (f = a.table().footer()) {
                    var f = d(f.cloneNode(!1)).appendTo(c), j = a.columns().footer().filter(function (b) {
                        return a.column(b).visible()
            ...
            var a = this.s.dt, b = a.cells({page: "current"}).nodes().to$(), c = a.settings()[0],
    ...
    i.breakpoints = [{name: "desktop", width: Infinity}, {name: "tablet-l", width: 1024}, {
        name: "tablet-p",
        width: 768
