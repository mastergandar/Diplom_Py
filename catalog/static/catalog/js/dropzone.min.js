...
var Emitter = function () {
    ...
    return _inherits(C, Emitter), _createClass(C, null, [{
        ...
        key: "_addFilesFromDirectory", value: function (e, s) {
            function t(t) {
        ...
        key: "resizeImage", value: function (r, e, t, n, o) {
            var a = this;
        ...
        key: "displayExistingFile", value: function (t, e, n, i, r) {
            var o = this, a = !(4 < arguments.length && void 0 !== r) || r;
        ...
        key: "createThumbnailFromUrl", value: function (o, a, l, s, t, u, e) {
            ...
            return e && (d.crossOrigin = e), d.onload = function () {
                ...
                return "undefined" != typeof EXIF && null !== EXIF && t && (e = function (e) {
                    ...
                    var t = c.options.resize.call(c, o, a, l, s), n = document.createElement("canvas"),
                        i = n.getContext("2d");
        ...
        key: "cancelUpload", value: function (e) {
            if (e.status === C.UPLOADING) {
                var t = this._getFilesWithXhr(e.xhr), n = !0, i = !1, r = void 0;
                try {
                ...
                if (s[0].upload.chunked) {
                    ...
                    var i = function () {
                        ...
                        if (!(e >= r.upload.totalChunkCount)) {
                            0;
                            var t = e * u.options.chunkSize, n = Math.min(t + u.options.chunkSize, r.size), i = {
        ...
        key: "_uploadData", value: function (t, e) {
            var n = this, i = new XMLHttpRequest, r = !0, o = !1, a = void 0;
            try {
            ...
            var u = this.resolveOption(this.options.method, t), c = this.resolveOption(this.options.url, t);
            ...
            var d = {Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest"};
            ...
            if ("FORM" === this.element.tagName) {
                ...
                try {
                    for (var r, o = this.element.querySelectorAll("input, textarea, select, button")[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                        var a = r.value, l = a.getAttribute("name"), s = a.getAttribute("type");
...
Dropzone.createElement = function (e) {
    ...
    if (!t) return !0;
    t = t.split(",");
    var n = e.type, i = n.replace(/\/.*$/, ""), r = !0, o = !1, a = void 0;
    try {
        for (var l, s = t[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) {
            var u = l.value;
...
var detectVerticalSquash = function (e) {
    ...
    return _createClass(e, null, [{
        ...
        key: "insertExif", value: function (e, t) {
            var n = e.replace("data:image/jpeg;base64,", ""), i = this.decode64(n), r = i.indexOf(255, 3),
                o = i.slice(0, r), a = i.slice(r), l = o;
        ...
        key: "decode64", value: function (e) {
            var t = void 0, n = void 0, i = "", r = void 0, o = void 0, a = "", l = 0, s = [];
