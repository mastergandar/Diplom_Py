...
var jsonData_t = loadJson('#jsonData_t');
var jsonData_l = loadJson('#jsonData_l');


var tyrv = jsonData_t.map((item) => item.data_ty)
console.log(tyrv)
var lyrv = jsonData_l.map((item) => item.data_ly)
console.log(lyrv)
console.log([23,32,27,38,27,32,27,38,22,31,21,16])
var options = {
    series: [{
        name: "2021",
        type: "column",
        data: tyrv
    }, {name: "2020", type: "line", data: lyrv}],
