...
!function (t, e) {
    ...
    var f = function () {
        ...
        return a(t, [{
            ...
            key: "renderPaths", value: function (t) {
                var e, i = t.j, a = t.realIndex, s = t.pathFrom, r = t.pathTo, o = t.stroke, l = t.strokeWidth,
                    ...
                    y = void 0 === v || v, w = t.drawShadow, k = void 0 === w || w, A = this.w, S = new x(this.ctx),
                    C = new p(this.ctx), L = this.w.config.chart.animations.enabled,
            ...
            key: "pathMouseEnter", value: function (t, e) {
                var i = this.w, a = new x(this.ctx), s = parseInt(t.node.getAttribute("index"), 10),
        ...
        return a(t, [{
            ...
            key: "checkComboSeries", value: function (t) {
                ...
                })), a > 1 && (e = !0), {comboBarCount: i, comboCharts: e}
            }
        }, {
    ...
    var A = {
        ...
        return a(t, [{
            ...
            key: "addAnnotationExternal", value: function (t) {
                var e = t.params, i = t.pushToMemory, a = t.context, s = t.type, r = t.contextMethod, n = a, o = n.w,
                    ...
                    h = l.childNodes.length + 1, c = new S,
        ...
        return a(t, [{
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, n) {
                var o, l = this.w, h = s, c = new p(this.ctx), d = new x(this.ctx), g = new L(this.ctx),
                    u = new P(this.ctx), f = new b(this.ctx), m = u.getMarkerConfig("apexcharts-marker", h),
                    v = g.fillPath({
                        seriesNumber: s,
                        dataPointIndex: r,
                ...
                if (l.globals.dataChanged && "circle" === m.shape) if (this.dynamicAnim) {
                    ...
                    0 === t && 0 === e && (a = 0), c.animateCircle(o, {cx: k, cy: A, r: S}, {
                        cx: t,
                        cy: e,
                        r: a
                    }, T, l.globals.easing)
        ...
        return a(t, [{
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                ...
                var u = new z(this.barCtx.ctx), f = new b(this.barCtx.ctx), p = c.formatter, x = null,
        ...
        return a(t, [{
            ...
            key: "barBackground", value: function (t) {
                var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, n = t.y2, o = t.elSeries, l = this.w,
                    h = new b(this.barCtx.ctx), c = new M(this.barCtx.ctx).getActiveConfigSeriesIndex();
            ...
            key: "getColumnPaths", value: function (t) {
                ...
                var u = {barWidth: e, strokeWidth: n, yRatio: a, barXPosition: i, y1: s, y2: r},
                    f = this.getRoundedBars(d, u, o, h, c), p = i, x = i + e, m = g.move(p, s), v = g.move(p, s),
                    y = g.line(x - n, s);
        ...
        return a(t, [{
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, n = t.pathFrom, o = t.pathTo,
                    ...
                    p = t.barHeight, m = t.barWidth, v = t.barYPosition, y = t.elDataLabelsWrap, w = t.visibleSeries,
        ...
        return a(t, [{
            ...
            key: "getTimeUnitsfromTimestamp", value: function (t, e, i) {
                ...
                var s = this.getDate(t), r = this.getDate(e), n = this.formatDate(s, "yyyy MM dd HH mm ss").split(" "),
        ...
        return a(s, [{
            ...
            key: "getTooltipValues", value: function (t) {
                var e = t.ctx, i = t.seriesIndex, a = t.dataPointIndex, s = t.y1, r = t.y2, n = t.w,
                    ...
                    c = n.config.series[i].name ? n.config.series[i].name : "", d = n.config.tooltip.y.formatter,
        ...
        return a(i, [{
            ...
            key: "checkForCatToNumericXAxis", value: function (t, e, i) {
                var a = new R(i), s = "bar" === t && i.plotOptions && i.plotOptions.bar && i.plotOptions.bar.horizontal,
        ...
        return a(t, [{
            ...
            key: "parseDataAxisCharts", value: function (t) {
                var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx,
                    a = this.w.config, s = this.w.globals, r = new Y(i),
        ...
        return a(t, [{
            ...
            key: "exportToCSV", value: function (t) {
                var e = this, i = t.series, a = t.columnDelimiter, s = t.lineDelimiter, r = void 0 === s ? "\n" : s,
                    n = this.w, o = [], l = [], h = "data:text/csv;charset=utf-8,\ufeff", c = new N(this.ctx),
        ...
        return a(t, [{
            key: "niceScale", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10,
                    a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                    s = arguments.length > 4 ? arguments[4] : void 0, r = this.w, n = Math.abs(e - t);
            ...
            key: "logarithmicScale", value: function (t) {
        ...
        return a(t, [{
            key: "drawXCrosshairs", value: function () {
                var t = this.w, e = new b(this.ctx), i = new x(this.ctx), a = t.config.xaxis.crosshairs.fill.gradient,
                    ...
                    u = s.top, p = s.blur, m = s.color, v = s.opacity, y = t.config.xaxis.crosshairs.fill.color;
        ...
        return a(t, [{
            ...
            key: "additionalPaddingXLabels", value: function (t) {
                ...
                var o = i.config.yaxis[0].opposite && i.globals.isBarHorizontal, l = function (t, s) {
                    (function (t) {
            ...
            key: "getyAxisLabelsCoords", value: function () {
                ...
                return e.config.yaxis.map((function (r, n) {
                    ...
                    if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                        ...
                        var u = new b(t.dCtx.ctx), p = "rotate(".concat(r.labels.rotate, " 0 0)"),
                            x = u.getTextRects(c, r.labels.style.fontSize, r.labels.style.fontFamily, p, !1), m = x;
            ...
            key: "getyAxisTitleCoords", value: function () {
                ...
                return e.config.yaxis.map((function (e, a) {
                    if (e.show && void 0 !== e.title.text) {
                        var s = new b(t.dCtx.ctx), r = "rotate(".concat(e.title.rotate, " 0 0)"),
        ...
        return a(t, [{
            ...
            key: "drawLegends", value: function () {
                ...
                for (var n = e.globals.legendFormatter, o = e.config.legend.inverseOrder, l = o ? a.length - 1 : 0; o ? l >= 0 : l <= a.length - 1; o ? l-- : l++) {
                    var h = n(a[l], {seriesIndex: l, w: e}), c = !1, d = !1;
                    ...
                    var x = e.config.legend.markers.offsetX, m = e.config.legend.markers.offsetY,
        ...
        return a(s, [{
            ...
            key: "panScrolled", value: function (t, e) {
                var i = this.w, a = this.xyRatios, s = f.clone(i.globals.initialConfig.yaxis), r = a.xRatio,
                    n = i.globals.minX, o = i.globals.maxX;
        ...
        return a(t, [{
            key: "getNearestValues", value: function (t) {
                var e = t.hoverArea, i = t.elGrid, a = t.clientX, s = t.clientY, r = this.w, n = r.globals.gridWidth,
                    o = r.globals.gridHeight, l = n / (r.globals.dataPoints - 1), h = o / r.globals.dataPoints,
                    c = i.getBoundingClientRect(), d = this.hasBars();
        ...
        return a(t, [{
            ...
            key: "printLabels", value: function (t) {
                var e, i = this, a = t.i, s = t.j, r = t.values, o = t.ttItems, l = t.shared, h = t.e, c = this.w,
                    d = r.xVal, g = r.zVal, u = r.xAxisTTVal, f = "", p = c.globals.colors[a];
        ...
        return a(t, [{
            ...
            key: "moveStickyTooltipOverBars", value: function (t) {
                ...
                var r = e.globals.dom.baseEl.querySelector(".apexcharts-bar-series .apexcharts-series[rel='".concat(s, "'] path[j='").concat(t, "'], .apexcharts-candlestick-series .apexcharts-series[rel='").concat(s, "'] path[j='").concat(t, "'], .apexcharts-boxPlot-series .apexcharts-series[rel='").concat(s, "'] path[j='").concat(t, "'], .apexcharts-rangebar-series .apexcharts-series[rel='").concat(s, "'] path[j='").concat(t, "']")),
                    n = r ? parseFloat(r.getAttribute("cx")) : 0, o = r ? parseFloat(r.getAttribute("cy")) : 0,
        ...
        return a(t, [{
            key: "drawDynamicPoints", value: function () {
                var t = this.w, e = new b(this.ctx), i = new P(this.ctx),
        ...
        return a(s, [{
            key: "draw", value: function (t, e) {
                ...
                for (var o = s.group({class: "apexcharts-".concat(a.config.chart.type, "-series apexcharts-plot-series")}), l = function (n) {
                    i.isBoxPlot = "boxPlot" === a.config.chart.type || "boxPlot" === a.config.series[n].type;
                    var l, h, c = void 0, d = void 0, g = [], u = [], p = a.globals.comboCharts ? e[n] : n,
                        x = s.group({
                            class: "apexcharts-series",
                    ...
                    for (var y = s.group({class: "apexcharts-datalabels", "data:realIndex": p}), w = function (e) {
                        var s = i.barHelpers.getStrokeWidth(n, e, p), o = i.drawBoxPaths({
                            indexes: {i: n, j: e, realIndex: p},
                            x: c,
                            y: d,
                            xDivision: l,
                            barWidth: m,
                        ...
                        d = o.y, c = o.x, e > 0 && u.push(c + m / 2), g.push(d), o.pathTo.forEach((function (l, h) {
                            var g = !i.isBoxPlot && i.candlestickOptions.wick.useFillColor ? o.color[h] : a.globals.stroke.colors[n],
                                u = r.fillPath({seriesNumber: p, dataPointIndex: e, color: o.color[h], value: t[n][e]});
                            i.renderSeries({
                                realIndex: p,
                                pathFill: u,
                                lineFill: g,
            ...
            key: "drawBoxPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = (t.y, t.xDivision), s = t.barWidth, r = t.zeroH, n = t.strokeWidth,
                    ...
                    u = o.config.plotOptions.candlestick.colors.downward, f = "";
        ...
        return a(t, [{
            ...
            key: "calculateDataLabels", value: function (t) {
                var e = t.text, i = t.x, a = t.y, s = t.i, r = t.j, n = t.colorProps, o = t.fontSize,
                    l = this.w.config.dataLabels, h = new b(this.ctx), c = new z(this.ctx), d = null;
                if (l.enabled) {
            ...
            key: "draw", value: function (t) {
                ...
                for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                    ...
                    for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                        var m = this.helpers.getShadeColor(e.config.chart.type, h, p, this.negRange), v = m.color,
                            y = m.colorProps;
        ...
        return a(t, [{
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, a = new x(this.ctx), s = new b(this.ctx), r = new L(this.ctx),
                    n = s.group({class: "apexcharts-slices"}), o = this.initialAngle, l = this.initialAngle,
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (k = u / this.fullAngle * i.config.chart.animations.speed) && (k = 1), this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
                        ...
                        if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            var T = i.globals.dataLabels.style.colors[d], z = s.group({class: "apexcharts-datalabels"}),
                                I = s.drawText({
                                    x: A,
                                    y: S,
                                    text: C,
            ...
            key: "drawPolarElements", value: function (t) {
                var e = this.w, i = new j(this.ctx), a = new b(this.ctx), s = new kt(this.ctx), r = a.group(),
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                ...
                if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach((function (t, o) {
                    ...
                    u = e.graphics.group({class: "apexcharts-series-markers-wrap apexcharts-element-hidden"}), p = e.graphics.group({
                        class: "apexcharts-datalabels",
                        "data:realIndex": o
        ...
        return a(s, [{
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new x(this.ctx),
                    r = new L(this.ctx), n = this.getStrokeWidth(t);
                t.size = t.size - n / 2;
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = new L(this.ctx), s = new x(this.ctx), r = i.group(),
    ...
    var Tt, zt, It = function () {
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new b(this.ctx), s = new L(this.ctx),
        ...
        return a(t, [{
            key: "calculateTimeScaleTicks", value: function (t, e) {
                ...
                var o = s.getTimeUnitsfromTimestamp(t, e, this.utc), l = a.globals.gridWidth / r, h = l / 24,
                    c = h / 60, d = c / 60, g = Math.floor(24 * r), u = Math.floor(24 * r * 60),
                    f = Math.floor(24 * r * 60 * 60), p = Math.floor(r), x = Math.floor(r / 30),
                    b = Math.floor(r / 365), m = {
            ...
            key: "generateYearScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis, r = t.numberOfYears,
                    n = e.minYear, o = 0, l = new Y(this.ctx), h = "year";
            ...
            key: "generateMinuteScale", value: function (t) {
                var e = t.firstVal, i = (t.currentSecond, t.currentMinute, t.currentHour), a = t.currentDate,
                    s = t.currentMonth, r = t.currentYear, n = t.minutesWidthOnXAxis, o = t.secondsWidthOnXAxis,
                    l = t.numberOfMinutes, h = "minute", c = (60 - e.minSecond) * o, d = e.minMinute + 1, g = d + 1,
                    u = a, p = s, x = r, b = i;
                this.timeScaleArray.push({
                    position: c,
                    value: d,
            ...
            key: "mount", value: function () {
                ...
                return new Promise((function (s, r) {
                    ...
                    if ("front" === a.config.grid.position && n && a.globals.dom.elGraphical.add(n.el), "front" === a.config.xaxis.crosshairs.position && i.crosshairs.drawXCrosshairs(), "front" === a.config.yaxis[0].crosshairs.position && i.crosshairs.drawYCrosshairs(), "front" === a.config.annotations.position && (a.globals.dom.Paper.add(a.globals.dom.elAnnotations), i.annotations.drawAxesAnnotations()), !a.globals.noData) {
                        if (a.config.tooltip.enabled && !a.globals.noData && i.w.globals.tooltip.drawTooltip(e.xyRatios), a.globals.axisCharts && (a.globals.isXNumeric || a.config.xaxis.convertedCatToNumeric || a.globals.isTimelineBar)) (a.config.chart.zoom.enabled || a.config.chart.selection && a.config.chart.selection.enabled || a.config.chart.pan && a.config.chart.pan.enabled) && i.zoomPanSelection.init({xyRatios: e.xyRatios}); else {
